...
export function locate(matrix: BitMatrix): QRLocation[] {
  ...
  const { topRight, topLeft, bottomLeft } = reorderFinderPatterns(bestFinderPatternGroup.points[0], bestFinderPatternGroup.points[1], bestFinderPatternGroup.points[2]);
