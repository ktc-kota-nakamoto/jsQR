...
function jsQR(data, width, height, providedOptions) {
    ...
    var _a = binarizer_1.binarize(data, width, height, shouldInvert, options.greyScaleWeights, options.canOverwriteImage), binarized = _a.binarized, inverted = _a.inverted;
